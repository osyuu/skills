...
**英文內建也只是起點，不是蓋好了。** 量過：`Committed.`、`It builds.`、`All good.`、
`CI is green.`、`It's running.` 這類最短的自然說法內建一條都認不得——英文沒有
「已經／了／完」這種完成態標記，收得太寬會對每一段技術對話開火，所以英文一律要求
**帶受詞或帶狀態詞**，剩下的靠 conf 補你自己真的會打的那幾句。
